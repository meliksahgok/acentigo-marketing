...
// Client component can't export metadata effectively like this in same file if it's strictly client, 
// but for this structure we'll keep it simple or move metadata to layout if needed. 
// Since layout.tsx handles metadata for this route generally, we focus on the UI here.
          ...
          <div className="lg:col-span-2 animate-fade-in-up [animation-delay:400ms]">
            <div className="bg-zinc-900/50 backdrop-blur-sm rounded-3xl border border-white/10 p-8 md:p-10 shadow-2xl">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="group">
                    <label htmlFor="phone" className="block text-sm font-medium text-gray-400 mb-2 group-focus-within:text-primary transition-colors">
                      Telefon
                    </label>
                    <input
                      type="tel"
                  ...
                  <div className="group">
                    <label htmlFor="company" className="block text-sm font-medium text-gray-400 mb-2 group-focus-within:text-primary transition-colors">
                      Şirket Adı
                    </label>
                    <input
                      type="text"
